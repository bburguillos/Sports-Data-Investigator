...
RATE_CASES = {'NFL': {'Mahomes · Passing Yards per Game': {'unit': 'passing yards per game',
                                              'total_label': 'passing yards',
                                              'total': 4839,
                                              'games': 17,
                                              'projection_games': 12,
                                              'story': 'Patrick Mahomes threw for 4,839 yards over 17 games.',
                                              'task_type': 'unit_rate'},
         'Jefferson · Receiving Yards per Game': {'unit': 'receiving yards per game',
                                                  'total_label': 'receiving yards',
                                                  'total': 1616,
                                                  'games': 17,
                                                  'projection_games': 10,
                                                  'story': 'Justin Jefferson recorded 1,616 receiving yards over 17 '
                                                           'games.',
                                                  'task_type': 'unit_rate'},
         'Allen · Touchdowns per Game': {'unit': 'touchdowns per game',
                                         'total_label': 'touchdowns',
                                         'total': 42,
                                         'games': 17,
                                         'projection_games': 12,
                                         'story': 'Josh Allen recorded 42 total touchdowns over 17 games.',
                                         'task_type': 'unit_rate'},
         'Henry · Yards per Carry': {'unit': 'yards per carry',
                                     'total_label': 'rushing yards',
                                     'total': 1538,
                                     'games': 280,
                                     'projection_games': 325,
                                     'story': 'Derrick Henry gained 1,538 rushing yards on 280 carries.',
                                     'task_type': 'unit_rate',
                                     'denominator_label': 'carries',
                                     'projection_label': 'carries'},
         'Receiver Catch Rate': {'unit': 'catches per target',
                                 'total_label': 'catches',
                                 'total': 84,
                                 'games': 126,
                                 'projection_games': 150,
                                 'story': 'A receiver caught 84 passes on 126 targets.',
                                 'task_type': 'unit_rate',
                                 'denominator_label': 'targets',
                                 'projection_label': 'targets'},
         'Field Goal Pace': {'unit': 'made field goals per attempt',
                             'total_label': 'made field goals',
                             'total': 27,
                             'games': 30,
                             'projection_games': 40,
         ...
         'Pace Comparison': {'unit': 'passing yards per game',
                             'total_label': 'passing yards',
                             'total': 900,
                             'games': 3,
                             'projection_games': 6,
                             'story': 'A quarterback throws for 900 passing yards over 3 games.',
                             'task_type': 'unit_rate',
                             'denominator_label': 'games',
                             'projection_label': 'games'},
         'Per-Minute Pace': {'unit': 'rushing yards per minute',
                             'total_label': 'rushing yards',
                             'total': 48,
                             'games': 12,
                             'projection_games': 20,
                             'story': 'A running back gains 48 rushing yards during 12 minutes of possession time.',
                             'task_type': 'unit_rate',
                             'denominator_label': 'minutes',
                             'projection_label': 'minutes'},
         'Per-Attempt Efficiency': {'unit': 'completions per pass attempt',
                                    'total_label': 'completions',
                                    'total': 18,
                                    'games': 30,
                                    'projection_games': 40,
                                    'story': 'A quarterback completes 18 passes on 30 pass attempts.',
                                    'task_type': 'unit_rate',
                                    'denominator_label': 'pass attempts',
                                    'projection_label': 'pass attempts'},
         'Missing-Value Proportion': {'unit': 'yards per drive',
                                      'total_label': 'yards',
                                      'total': 180,
                                      'games': 6,
                                      'projection_games': 10,
                                      'story': 'An offense gains 180 yards over 6 drives.',
                                      'task_type': 'unit_rate',
                                      'denominator_label': 'drives',
                                      'projection_label': 'drives'},
         'Short-to-Long Projection': {'unit': 'points per quarter',
                                      'total_label': 'points',
                                      'total': 14,
                                      'games': 2,
                                      'projection_games': 4,
                                      'story': 'A team scores 14 points over 2 quarters.',
                                      'task_type': 'unit_rate',
                                      'denominator_label': 'quarters',
                                      'projection_label': 'quarters'},
         'Rate Conversion Challenge': {'unit': 'yards per play',
                                       'total_label': 'yards',
                                       'total': 72,
                                       'games': 12,
                                       'projection_games': 20,
                                       'story': 'An offense gains 72 yards on 12 plays.',
                                       'task_type': 'unit_rate',
                                       'denominator_label': 'plays',
                                       'projection_label': 'plays'}},
 'NBA': {'Curry · Threes per Game': {'unit': 'made 3-pointers per game',
                                     'total_label': 'made 3-pointers',
                                     'total': 337,
                                     'games': 63,
                                     'projection_games': 70,
                                     'story': 'Stephen Curry made 337 three-pointers over 63 games.',
                                     'task_type': 'unit_rate'},
         'Jordan · Points per Game': {'unit': 'points per game',
                                      'total_label': 'points',
                                      'total': 3041,
                                      'games': 82,
                                      'projection_games': 60,
                                      ...
                                      'task_type': 'unit_rate'},
         'LeBron · Assists per Game': {'unit': 'assists per game',
                                       'total_label': 'assists',
                                       'total': 518,
                                       'games': 71,
                                       'projection_games': 65,
                                       ...
                                       'task_type': 'unit_rate'},
         'Free Throw Rate': {'unit': 'made free throws per attempt',
                             'total_label': 'made free throws',
                             'total': 72,
                             'games': 90,
                             'projection_games': 120,
                             'story': 'A player made 72 free throws in 90 attempts.',
                             'task_type': 'unit_rate',
                             'denominator_label': 'attempts',
                             'projection_label': 'attempts'},
         'Rebounds per Minute': {'unit': 'rebounds per minute',
                                 'total_label': 'rebounds',
                                 'total': 14,
                                 'games': 28,
                                 'projection_games': 36,
                                 ...
                                 'denominator_label': 'minutes',
                                 'projection_label': 'minutes'},
         'Team Scoring Pace': {'unit': 'points per quarter',
                               'total_label': 'points',
                               'total': 84,
                               'games': 3,
                               'projection_games': 4,
                               ...
                               'denominator_label': 'quarters',
                               'projection_label': 'quarters'},
         'Pace Comparison': {'unit': 'points per game',
                             'total_label': 'points',
                             'total': 84,
                             'games': 3,
                             'projection_games': 6,
                             'story': 'A player scores 84 points over 3 games.',
                             'task_type': 'unit_rate',
                             'denominator_label': 'games',
                             'projection_label': 'games'},
         'Per-Minute Pace': {'unit': 'points per minute',
                             'total_label': 'points',
                             'total': 24,
                             'games': 12,
                             'projection_games': 20,
                             'story': 'A player scores 24 points in 12 minutes.',
                             'task_type': 'unit_rate',
                             'denominator_label': 'minutes',
                             'projection_label': 'minutes'},
         'Per-Attempt Efficiency': {'unit': 'made shots per attempt',
                                    'total_label': 'made shots',
                                    'total': 9,
                                    'games': 15,
                                    'projection_games': 25,
                                    'story': 'A player makes 9 shots on 15 attempts.',
                                    'task_type': 'unit_rate',
                                    'denominator_label': 'attempts',
                                    'projection_label': 'attempts'},
         'Missing-Value Proportion': {'unit': 'assists per quarter',
                                      'total_label': 'assists',
                                      'total': 8,
                                      'games': 2,
                                      'projection_games': 4,
                                      'story': 'A team records 8 assists over 2 quarters.',
                                      'task_type': 'unit_rate',
                                      'denominator_label': 'quarters',
                                      'projection_label': 'quarters'},
         'Short-to-Long Projection': {'unit': 'rebounds per game',
                                      'total_label': 'rebounds',
                                      'total': 30,
                                      'games': 3,
                                      'projection_games': 8,
                                      'story': 'A player grabs 30 rebounds over 3 games.',
                                      'task_type': 'unit_rate',
                                      'denominator_label': 'games',
                                      'projection_label': 'games'},
         'Rate Conversion Challenge': {'unit': 'points per possession',
                                       'total_label': 'points',
                                       'total': 18,
                                       'games': 12,
                                       'projection_games': 20,
                                       'story': 'A team scores 18 points over 12 possessions.',
                                       'task_type': 'unit_rate',
                                       'denominator_label': 'possessions',
                                       'projection_label': 'possessions'}},
 'MLB': {'Judge · Home Runs per Game': {'unit': 'home runs per game',
                                        'total_label': 'home runs',
                                        'total': 62,
                                        'games': 157,
                                        'projection_games': 100,
                                        'story': 'Aaron Judge hit 62 home runs over 157 games in 2022.',
                                        'task_type': 'unit_rate'},
         'Ohtani · Home Runs per Game': {'unit': 'home runs per game',
                                         'total_label': 'home runs',
                                         'total': 54,
                                         'games': 159,
                                         'projection_games': 120,
                                         ...
                                         'task_type': 'unit_rate'},
         'Hits per At-Bat': {'unit': 'hits per at-bat',
                             'total_label': 'hits',
                             'total': 45,
                             'games': 150,
                             'projection_games': 200,
                             'story': 'A hitter recorded 45 hits in 150 at-bats.',
                             'task_type': 'unit_rate',
                             'denominator_label': 'at-bats',
                             'projection_label': 'at-bats'},
         'Strikeouts per Inning': {'unit': 'strikeouts per inning',
                                   'total_label': 'strikeouts',
                                   'total': 72,
                                   'games': 60,
                                   'projection_games': 90,
         ...
         'Runs per Inning': {'unit': 'runs per inning',
                             'total_label': 'runs',
                             'total': 18,
                             'games': 6,
                             'projection_games': 9,
                             ...
                             'denominator_label': 'innings',
                             'projection_label': 'innings'},
         'Stolen Base Pace': {'unit': 'stolen bases per game',
                              'total_label': 'stolen bases',
                              'total': 24,
                              'games': 40,
                              'projection_games': 75,
                              'story': 'A player stole 24 bases over 40 games.',
                              'task_type': 'unit_rate'},
         'Pace Comparison': {'unit': 'hits per game',
                             'total_label': 'hits',
                             'total': 12,
                             'games': 4,
                             'projection_games': 10,
                             'story': 'A hitter records 12 hits over 4 games.',
                             'task_type': 'unit_rate',
                             'denominator_label': 'games',
                             'projection_label': 'games'},
         'Per-Minute Pace': {'unit': 'pitches per inning',
                             'total_label': 'pitches',
                             'total': 45,
                             'games': 3,
                             'projection_games': 6,
                             'story': 'A pitcher throws 45 pitches over 3 innings.',
                             'task_type': 'unit_rate',
                             'denominator_label': 'innings',
                             'projection_label': 'innings'},
         'Per-Attempt Efficiency': {'unit': 'hits per at-bat',
                                    'total_label': 'hits',
                                    'total': 6,
                                    'games': 20,
                                    'projection_games': 40,
                                    'story': 'A hitter records 6 hits in 20 at-bats.',
                                    'task_type': 'unit_rate',
                                    'denominator_label': 'at-bats',
                                    'projection_label': 'at-bats'},
         'Missing-Value Proportion': {'unit': 'runs per inning',
                                      'total_label': 'runs',
                                      'total': 6,
                                      'games': 3,
                                      'projection_games': 9,
                                      'story': 'A team scores 6 runs over 3 innings.',
                                      'task_type': 'unit_rate',
                                      'denominator_label': 'innings',
                                      'projection_label': 'innings'},
         'Short-to-Long Projection': {'unit': 'strikeouts per inning',
                                      'total_label': 'strikeouts',
                                      'total': 8,
                                      'games': 4,
                                      'projection_games': 7,
                                      'story': 'A pitcher records 8 strikeouts over 4 innings.',
                                      'task_type': 'unit_rate',
                                      'denominator_label': 'innings',
                                      'projection_label': 'innings'},
         'Rate Conversion Challenge': {'unit': 'bases per hit',
                                       'total_label': 'total bases',
                                       'total': 12,
                                       'games': 8,
                                       'projection_games': 14,
                                       'story': 'A hitter records 12 total bases on 8 hits.',
                                       'task_type': 'unit_rate',
                                       'denominator_label': 'hits',
                                       'projection_label': 'hits'}},
 'NHL': {'McDavid · Points per Game': {'unit': 'points per game',
                                       'total_label': 'points',
                                       'total': 153,
                                       'games': 82,
                                       'projection_games': 60,
                                       ...
                                       'task_type': 'unit_rate'},
         'Matthews · Goals per Game': {'unit': 'goals per game',
                                       'total_label': 'goals',
                                       'total': 69,
                                       'games': 81,
                                       'projection_games': 60,
                                       ...
                                       'task_type': 'unit_rate'},
         'Shots per Game': {'unit': 'shots per game',
                            'total_label': 'shots',
                            'total': 96,
                            'games': 24,
                            'projection_games': 35,
                            ...
                            'task_type': 'unit_rate'},
         'Saves per Shot': {'unit': 'saves per shot',
                            'total_label': 'saves',
                            'total': 45,
                            'games': 50,
                            'projection_games': 80,
         ...
         'Penalty Minutes per Game': {'unit': 'penalty minutes per game',
                                      'total_label': 'penalty minutes',
                                      'total': 36,
                                      'games': 18,
                                      'projection_games': 30,
                                      'story': 'A player accumulated 36 penalty minutes over 18 games.',
                                      'task_type': 'unit_rate'},
         'Power-Play Goals per Chance': {'unit': 'goals per power-play chance',
                                         'total_label': 'power-play goals',
                                         'total': 12,
                                         'games': 48,
                                         'projection_games': 80,
         ...
         'Pace Comparison': {'unit': 'shots per game',
                             'total_label': 'shots',
                             'total': 24,
                             'games': 3,
                             'projection_games': 6,
                             'story': 'A player takes 24 shots over 3 games.',
                             'task_type': 'unit_rate',
                             'denominator_label': 'games',
                             'projection_label': 'games'},
         'Per-Minute Pace': {'unit': 'shots per minute',
                             'total_label': 'shots',
                             'total': 12,
                             'games': 20,
                             'projection_games': 30,
                             'story': 'A team takes 12 shots during 20 minutes of play.',
                             'task_type': 'unit_rate',
                             'denominator_label': 'minutes',
                             'projection_label': 'minutes'},
         'Per-Attempt Efficiency': {'unit': 'goals per shot',
                                    'total_label': 'goals',
                                    'total': 3,
                                    'games': 15,
                                    'projection_games': 25,
                                    'story': 'A player scores 3 goals on 15 shots.',
                                    'task_type': 'unit_rate',
                                    'denominator_label': 'shots',
                                    'projection_label': 'shots'},
         'Missing-Value Proportion': {'unit': 'saves per period',
                                      'total_label': 'saves',
                                      'total': 18,
                                      'games': 2,
                                      'projection_games': 3,
                                      'story': 'A goalie makes 18 saves over 2 periods.',
                                      'task_type': 'unit_rate',
                                      'denominator_label': 'periods',
                                      'projection_label': 'periods'},
         'Short-to-Long Projection': {'unit': 'penalty minutes per game',
                                      'total_label': 'penalty minutes',
                                      'total': 8,
                                      'games': 4,
                                      'projection_games': 10,
                                      'story': 'A team records 8 penalty minutes over 4 games.',
                                      'task_type': 'unit_rate',
                                      'denominator_label': 'games',
                                      'projection_label': 'games'},
         'Rate Conversion Challenge': {'unit': 'power-play goals per chance',
                                       'total_label': 'power-play goals',
                                       'total': 4,
                                       'games': 16,
                                       'projection_games': 24,
                                       'story': 'A team scores 4 power-play goals on 16 power-play chances.',
                                       'task_type': 'unit_rate',
                                       'denominator_label': 'power-play chances',
                                       'projection_label': 'power-play chances'}},
 'Soccer': {'Messi · Goals per Match': {'unit': 'goals per match',
                                        'total_label': 'goals',
                                        'total': 43,
                                        'games': 38,
                                        'projection_games': 30,
                                        ...
                                        'task_type': 'unit_rate'},
            'Haaland · Goals per Match': {'unit': 'goals per match',
                                          'total_label': 'goals',
                                          'total': 36,
                                          'games': 35,
                                          'projection_games': 30,
                                          ...
                                          'task_type': 'unit_rate'},
            'Passes per Minute': {'unit': 'completed passes per minute',
                                  'total_label': 'completed passes',
                                  'total': 54,
                                  'games': 90,
                                  'projection_games': 60,
                                  ...
                                  'denominator_label': 'minutes',
                                  'projection_label': 'minutes'},
            'Shots per Match': {'unit': 'shots per match',
                                'total_label': 'shots',
                                'total': 28,
                                'games': 7,
                                'projection_games': 12,
                                ...
                                'task_type': 'unit_rate'},
            'Penalty Conversion Rate': {'unit': 'goals per penalty attempt',
                                        'total_label': 'penalty goals',
                                        'total': 8,
                                        'games': 10,
                                        'projection_games': 15,
            ...
            'Team Points per Match': {'unit': 'table points per match',
                                      'total_label': 'table points',
                                      'total': 21,
                                      'games': 9,
                                      'projection_games': 15,
                                      'story': 'A club earned 21 table points over 9 matches.',
                                      'task_type': 'unit_rate'},
            'Pace Comparison': {'unit': 'goals per match',
                                'total_label': 'goals',
                                'total': 6,
                                'games': 3,
                                'projection_games': 8,
                                'story': 'A player scores 6 goals over 3 matches.',
                                'task_type': 'unit_rate',
                                'denominator_label': 'matches',
                                'projection_label': 'matches'},
            'Per-Minute Pace': {'unit': 'completed passes per minute',
                                'total_label': 'completed passes',
                                'total': 30,
                                'games': 15,
                                'projection_games': 45,
                                'story': 'A midfielder completes 30 passes over 15 minutes.',
                                'task_type': 'unit_rate',
                                'denominator_label': 'minutes',
                                'projection_label': 'minutes'},
            'Per-Attempt Efficiency': {'unit': 'goals per shot',
                                       ...
                                       'games': 20,
                                       'projection_games': 30,
                                       'story': 'A forward scores 4 goals on 20 shots.',
                                       'task_type': 'unit_rate',
                                       'denominator_label': 'shots',
                                       'projection_label': 'shots'},
            'Missing-Value Proportion': {'unit': 'shots per match',
                                         'total_label': 'shots',
                                         'total': 18,
                                         'games': 3,
                                         'projection_games': 5,
                                         'story': 'A team takes 18 shots over 3 matches.',
                                         'task_type': 'unit_rate',
                                         'denominator_label': 'matches',
                                         'projection_label': 'matches'},
            'Short-to-Long Projection': {'unit': 'table points per match',
                                         'total_label': 'table points',
                                         'total': 9,
                                         'games': 3,
                                         'projection_games': 8,
                                         'story': 'A club earns 9 table points over 3 matches.',
                                         'task_type': 'unit_rate',
                                         'denominator_label': 'matches',
                                         'projection_label': 'matches'},
            'Rate Conversion Challenge': {'unit': 'successful tackles per attempt',
                                          'total_label': 'successful tackles',
                                          'total': 6,
                                          'games': 10,
                                          'projection_games': 20,
                                          'story': 'A defender makes 6 successful tackles in 10 attempts.',
                                          'task_type': 'unit_rate',
                                          'denominator_label': 'attempts',
                                          'projection_label': 'attempts'}},
 'Formula 1': {'Verstappen · Points per Race': {'unit': 'championship points per race',
                                                'total_label': 'championship points',
                                                'total': 575,
                                                'games': 22,
                                                'projection_games': 20,
                                                'story': 'Max Verstappen scored 575 championship points over 22 races '
                                                         'in 2023.',
                                                'task_type': 'unit_rate'},
               'Hamilton · Points per Race': {'unit': 'championship points per race',
                                              'total_label': 'championship points',
                                              'total': 413,
                                              'games': 21,
                                              'projection_games': 18,
                                              'story': 'Lewis Hamilton scored 413 championship points over 21 races in '
                                                       '2019.',
                                              'task_type': 'unit_rate'},
               'Laps per Minute': {'unit': 'laps per minute',
                                   'total_label': 'laps',
                                   'total': 18,
                                   'games': 27,
                                   'projection_games': 45,
                                   ...
                                   'denominator_label': 'minutes',
                                   'projection_label': 'minutes'},
               'Pit Stops per Race': {'unit': 'pit stops per race',
                                      'total_label': 'pit stops',
                                      'total': 12,
                                      'games': 6,
                                      'projection_games': 10,
                                      'story': 'A team made 12 pit stops over 6 races.',
                                      'task_type': 'unit_rate'},
               'Fuel per Lap': {'unit': 'liters per lap',
                                'total_label': 'liters of fuel',
                                'total': 90,
                                'games': 50,
                                'projection_games': 70,
               ...
               'Points per Sprint': {'unit': 'points per sprint',
                                     'total_label': 'points',
                                     'total': 24,
                                     'games': 4,
                                     'projection_games': 7,
               ...
               'Pace Comparison': {'unit': 'points per race',
                                   'total_label': 'championship points',
                                   'total': 45,
                                   'games': 3,
                                   'projection_games': 8,
                                   'story': 'A driver earns 45 championship points over 3 races.',
                                   'task_type': 'unit_rate',
                                   'denominator_label': 'races',
                                   'projection_label': 'races'},
               'Per-Minute Pace': {'unit': 'laps per minute',
                                   'total_label': 'laps',
                                   'total': 10,
                                   'games': 20,
                                   'projection_games': 30,
                                   'story': 'A driver completes 10 laps in 20 minutes.',
                                   'task_type': 'unit_rate',
                                   'denominator_label': 'minutes',
                                   'projection_label': 'minutes'},
               'Per-Attempt Efficiency': {'unit': 'successful pit stops per attempt',
                                          'total_label': 'successful pit stops',
                                          'total': 8,
                                          'games': 10,
                                          'projection_games': 15,
                                          'story': 'A team completes 8 successful pit stops in 10 attempts.',
                                          'task_type': 'unit_rate',
                                          'denominator_label': 'attempts',
                                          'projection_label': 'attempts'},
               'Missing-Value Proportion': {'unit': 'laps per stint',
                                            'total_label': 'laps',
                                            'total': 36,
                                            'games': 3,
                                            'projection_games': 5,
                                            'story': 'A driver completes 36 laps over 3 stints.',
                                            'task_type': 'unit_rate',
                                            'denominator_label': 'stints',
                                            'projection_label': 'stints'},
               'Short-to-Long Projection': {'unit': 'liters per lap',
                                            'total_label': 'liters of fuel',
                                            'total': 30,
                                            'games': 15,
                                            'projection_games': 40,
                                            'story': 'A car uses 30 liters of fuel over 15 laps.',
                                            'task_type': 'unit_rate',
                                            'denominator_label': 'laps',
                                            'projection_label': 'laps'},
               'Rate Conversion Challenge': {'unit': 'points per sprint',
                                             'total_label': 'points',
                                             'total': 12,
                                             'games': 3,
                                             'projection_games': 6,
                                             'story': 'A driver earns 12 points over 3 sprint races.',
                                             'task_type': 'unit_rate',
                                             'denominator_label': 'sprints',
                                             'projection_label': 'sprints'}}}
...
def make_dynamic_ratio_case(sport, template, previous=None):
    ...
    # Keep the generated wording tied to the actual sports quantity.
    # Do not fall back to vague labels such as "units" or generic "periods."
    if bounded_key in bounded_success_rates:
        case["story"] = (
